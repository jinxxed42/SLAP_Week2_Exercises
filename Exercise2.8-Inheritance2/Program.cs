namespace Exercise2._8_Inheritance2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Weekly wage is: " + mechanic.CalcWeeklyWage());
            ...
            Console.WriteLine("Weekly wage is: " + foreman.CalcWeeklyWage());
            ...
            Console.WriteLine("Weekly wage is: " + vehicleInspector.CalcWeeklyWage());
