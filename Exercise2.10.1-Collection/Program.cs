namespace Exercise2._10._1_Collection
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            else Console.WriteLine(worker.ToString()); // Should be Anders Filipsen, but is null
            ...
            else Console.WriteLine(worker.ToString()); // Should be Anette Vistisen, but is null
